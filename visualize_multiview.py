...
function layout3d() {
  return {
    ...
    scene:{
      xaxis:{title:'C·cos(H)', range:[-.4,.4], ...darkAxis},
      yaxis:{title:'C·sin(H)', range:[-.4,.4], ...darkAxis},
      zaxis:{title:'Lightness (L)', range:[0,1], ...darkAxis},
...
function layoutLC() {
  return {
    ...darkBg,
    margin:{l:44,r:10,b:36,t:6},
    xaxis:{title:'Chroma (C)', range:[0,0.4], ...darkAxis},
    yaxis:{title:'Lightness (L)', range:[0,1], ...darkAxis},
...
function layoutCH() {
  return {
    ...darkBg,
    margin:{l:36,r:10,b:36,t:6},
    xaxis:{title:'C·cos(H)', range:[-.4,.4], ...darkAxis, scaleanchor:'y', scaleratio:1},
    yaxis:{title:'C·sin(H)', range:[-.4,.4], ...darkAxis},
    shapes: polarShapes(),
...
function layoutLH() {
  return {
    ...darkBg,
    margin:{l:44,r:10,b:36,t:6},
    xaxis:{title:'Hue (H°)', range:[0,360], dtick:60, ...darkAxis},
    yaxis:{title:'Lightness (L)', range:[0,1], ...darkAxis},
    showlegend:false, hovermode:'closest', dragmode:'select',
  };
}
...
function _doRender() {
  ...
  Plotly.react('view3d', buildTraces3d(), layout3d());
  Plotly.react('viewLC', buildTracesLC(), layoutLC());
  Plotly.react('viewCH', buildTracesCH(), layoutCH());
  Plotly.react('viewLH', buildTracesLH(), layoutLH());
